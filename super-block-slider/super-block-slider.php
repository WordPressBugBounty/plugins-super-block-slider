 ...
 * Description:     Lightweight image/video & content slider for block and classic editor.
 * Version:         2.8.3.8
 * Author:          mikemmx
...
define('SUPERBLOCKSLIDER_VERSION', '2.8.3.8');
...
function superblockslider_register_block() {
    ...
    // Register the block
    register_block_type(SUPERBLOCKSLIDER_DIR);
}
